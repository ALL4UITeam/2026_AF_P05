$(document).ready(function(){
	...
	// ===============================
	// ✅ floatThead + min-width 100% (가로 스크롤 없을 때)
	// - 절대 숨김 상태에서 init 하지 않음 (헤더 사라짐 방지)
	// - 가로 스크롤 없으면 table min-width=100%
	// ===============================
	function applyFloatTheadAndMinWidth($scope){
		$scope.find('table.tbl.h-scroll').each(function(){
			...
			// ✅ 숨김 상태면 절대 건드리지 않기 (헤더 날아가는 1순위 원인)
			...
			// ✅ floatThead가 박은 min-width(px) 제거 후, 가로 스크롤 없으면 100%
